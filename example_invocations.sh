...
# moa experiments
python moa_experiments.py  --moajar $MOA_JAR --input /home/tvas/data/airlines-orig/one-hot/2M  --repeats 10 --window 1000 --njobs 5 --meta OoBConformalApproximate --save-predictions --learner-threads 4 --verbose 1 --measure-model-size --output /home/tvas/output/2M/OoBConformalApproximate

# parameter sweep for algorithm
./parameter_sweep.py --command "python moa_experiments.py  --moajar $MOA_JAR --input /home/tvas/data/moa-regression/missing  --repeats 10 --window 1000 --njobs 2 --max-calibration-instances 1000 --save-predictions --learner-threads 1 --verbose 1 --measure-model-size" --output-prefix /home/tvas/output/uncertain-trees/moa-regression/missing/ --sweep-argument meta --argument-list OnlineQRF OoBConformalApproximate OoBConformalRegressor
