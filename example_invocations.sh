...
# moa experiments
python moa_experiments.py  --moajar $MOA_JAR --input /home/tvas/data/airlines-orig/one-hot/10k  --repeats 4 --window 1000 --njobs 2 --meta OoBConformalApproximate --learner-threads 2 --verbose 1 --output /home/tvas/Dropbox/SICS/uncertain-trees/results/output/airline-orig/test/OoBConformalApproximate

# parameter sweep for algorithm
./parameter_sweep.py --command "python moa_experiments.py  --moajar $MOA_JAR --input /home/tvas/data/moa-regression/large  --repeats 2 --window 1000 --njobs 2 --max-calibration-instances 1000  --learner-threads 1 --verbose 1" --output-prefix /home/tvas/output/uncertain-trees/moa-regression/large --sweep-argument meta --argument-list  OoBConformalApproximate OoBConformalRegressor

# parameter sweep for num calibration instances
./parameter_sweep.py --command "python moa_experiments.py  --moajar $MOA_JAR --input /lhome/tvas/data/moa-regression/  --repeats 10 --window 1000 --njobs 2 --meta meta.OoBConformalRegressor  --learner-threads 2 --overwrite --verbose 1" --sweep-argument max-calibration-instances --output-prefix /lhome/tvas/output/uncertain-trees/moa-regression/onlinecp-max-cal-instances --argument-range 100 1001 100
...
./parameter_sweep.py --command "python moa_experiments.py  --moajar $MOA_JAR --input /home/tvas/data/small-mid/  --repeats 1 --window 1000 --njobs 4 --learner-threads 1 --overwrite --verbose 1" --sweep-argument meta --output-prefix /home/tvas/output/uncertain-trees/small-mid/moa-confidence --argument-list OnlineQRF  OoBConformalApproximate  OoBConformalRegressor --inner-sweep-argument confidence --argument-list 0.95 0.99